...
The official 2026 GTFS publication from Geschäftsstelle SKI on behalf of BAV was inspected as a reproducible static source. Calendar/exception validation for 22 August 2026 showed the earlier trip 20253 identifier was inactive; active S17 trip `.ojp-91-17-M.1.TA.200.j26` (12353) has the required 14:03/14:05/14:11/14:14 calls. The same operating window supplies active trains 11448, 11648 and 2025. Compact calls are committed; the 225 MB source archive remains ignored under `data/raw/`.
