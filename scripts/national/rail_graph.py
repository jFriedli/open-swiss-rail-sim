...
class Handler(osmium.SimpleHandler):
    def __init__(self): super().__init__();self.nodes={};self.edges=[];self.ways=0;self.unsupported=Counter();self.switches=set();self.signals=set()
    def way(self,w):
